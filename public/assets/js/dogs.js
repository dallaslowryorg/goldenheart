window.GOLDEN_HEART_DOGS = [
  ...
  {name:'Oakley', location:'Oklahoma', status:'Full-Time Placement • Graduating Soon', group:'matched', image:'oakley.webp', blurb:'Oakley has moved into full-time life with a client in Oklahoma and is approaching graduation.'},
  {name:'Winston', location:'Arkansas', status:'Transitioning to Full-Time • Graduating Soon', group:'matched', image:'winston.webp', blurb:'Winston is preparing to transition into full-time placement with a client in Arkansas and is nearing graduation.'},
  ...
  {name:'Ruby', year:'2026', status:'Graduate', group:'graduate', image:'ruby.webp', blurb:'Ruby is a 2026 Golden Heart Service Dogs graduate.'},
  {name:'Whiskey', year:'2026', status:'Graduate', group:'graduate', image:'whiskey.webp', blurb:'Whiskey is a 2026 Golden Heart Service Dogs graduate.'},
  {name:'Murphy', year:'2026', status:'Graduate', group:'graduate', image:'murphy.webp', blurb:'Murphy is a 2026 Golden Heart Service Dogs graduate.'},
...
function dogCard(dog){
  ...
  return `<article class="dog-card" id="${dog.name.toLowerCase().replace(/[^a-z0-9]+/g,'-')}">
    <div class="dog-photo"><img loading="lazy" src="/assets/images/dogs/${dog.image}" alt="${dog.name}, Golden Heart service dog${dog.group==='graduate'?' graduate':''}"></div>
